...
if __name__ == '__main__':
    pred = np.asarray(Image.open(
        '/home/lart/Coding/CODProj/output/FPNWithMSV0_S384_BS8_E60_AMPy_LR0'
        '.004_LTpoly_OPsgd_OTtrick_MSn_INFOsparse'
        '/FPNWithMSV0_S384_BS8_E60_AMPy_LR0'
        '.004_LTpoly_OPsgd_OTtrick_MSn_INFOsparse/cod10k/COD10K-CAM-1'
        '-Aquatic-1-BatFish-6.png'))
    gt = np.asarray(Image.open(
        '/home/lart/Datasets/Saliency/COD/Test/COD10K/Mask/COD10K-CAM-1'
        '-Aquatic-1-BatFish-6.png'))
    iw_ssim = IW_SSIM()
